...
def load_segnet(checkpoint_path=None):
    ...
    model = load_model(
        checkpoint_path,
        custom_objects={"custom_dice": custom_dice}
    )
    print(f"Loaded SegNet model from: {checkpoint_path}")
