...
def process_all_patients(dicom_base_folder, output_base_folder, velocity_base_folder):
    """
...
def main():
    ...
    process_all_patients(dicom_base_folder, output_base_folder, velocity_base_folder)
